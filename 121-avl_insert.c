...
/**
 * r_insert_node - node value instertion into an AVL.
 * @tree: pointer of root node of the AVL tree struct.
 * @parent: parent node of struct AVL.
 * @new: pointer left or right insertion.
 * @nval: insertion value to the AVL.
 * Return: pointer after insertion otherwise NULL
 */
...
/**
 * avl_insert - inserts a new value into an AVL tree.
 * @tree: pointer to the root node of the AVL tree to insert into.
 * @value: value to store in the node to be inserted into avl
...
avl_t *avl_insert(avl_t **tree, int value)
{
	...
	r_insert_node(tree, *tree, &n, value);
	return (n);
}
